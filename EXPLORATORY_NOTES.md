...
> **Speculative extensions and analogies — not part of the main technical claim.**
>
> The material in this file was the public README of the repository through
> 2026-05-18. It frames the same code in broader, more speculative terms —
> primitive-set rhetoric, the universe / boundary-rider / cosmology-web
> analogies, and the original Max-Cut numbers reported before the symmetric-W
> correction and the multi-seed benchmark protocol landed.
>
> It is preserved here verbatim for context. The main README now describes the
> work in conservative, research-facing terms: budgeted Hebbian Kuramoto with
> fixed support, symmetric-Frobenius projection, an identified Lyapunov
> function, and a hardware-calibration framing. Treat anything below as
> direction-of-travel rather than a load-bearing claim.
